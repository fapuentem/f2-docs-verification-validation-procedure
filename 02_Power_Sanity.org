...
* Purpose
Screen for gross electrical issues *before any power is applied*. The goal is to catch shorts, and assembly errors that could damage the board or bench supply during first power-on.
...
- ESD accessories
- [[https://drive.google.com/drive/folders/1JVN5esHxpJAKt_KkhkdePhA0U1uXdHZs?usp=drive_link][Board documentation / schematic references]]
...
|-----------------------------+------------+-------+-------+-------|
| +5V input cap (TP1 - GND)   |            | kΩ    |       |       |
| +5V input cap (TP57 - GND)  |            | kΩ    |       |       |
| +5V input cap (TP48 - GND)  |            | kΩ    |       |       |
...
| Rail / Node                 | Resistance | Units | Pass? | Notes |
|-----------------------------+------------+-------+-------+-------|
| +3V3 input cap (TP58 - GND) |            | kΩ    |       |       |
| +3V3 input cap (TP51 - GND) |            | kΩ    |       |       |
...
| Rail / Node                 | Resistance | Units | Pass? | Notes |
|-----------------------------+------------+-------+-------+-------|
| +1V8 input cap (TP30 - GND) |            | kΩ    |       |       |
| +1V8 input cap (TP61 - GND) |            | kΩ    |       |       |
